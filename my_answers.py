...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        def activation_function(self,x=0):
    ...
    def forward_pass_train(self, X):
        ...
        #hidden_outputs = self.activation_function(np.dot(self.hidden_nodes,self.weights_hidden_to_output))
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print("t: {} l: {} v: {}".format(type(delta_weights_i_h),delta_weights_i_h.shape,delta_weights_i_h))
        #print("t: {} v: {}".format(type(X),X))
        # Weight step (input to hidden)
        delta_weights_i_h += hidden_error_term*X[:,None]
        #delta_weights_i_h += hidden_error_term*X
        # Weight step (hidden to output)
        #print("t: {} l: {} v: {}".format(type(output_error_term),output_error_term.shape,output_error_term))
        #print("t: {} l: {} v: {}".format(type(hidden_outputs[:,None]),hidden_outputs[:,None].shape,hidden_outputs[:,None]))
